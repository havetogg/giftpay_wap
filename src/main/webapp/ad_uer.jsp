...
<!DOCTYPE html>
<html lang="en" style="background: #1b131e">
<head>
    <meta charset="UTF-8">
...
<div class="zoomer">
    <div class="content">
        <div class="content" style="background: #1b131e;margin-bottom: -50px;">
            <img src="img/201509303.jpg" alt=""/>
        </div>
    </div>
</div>
...
<!--</div>-->
<!--<div class="name"style="font-size: 30px;color: white;position: absolute;top: 5px;left: 150px;">小美队长</div>-->
<!--<div class="phone" style="font-size: 30px;color: white;position: absolute;top: 44px;left: 144px;">1526569999</div>-->
