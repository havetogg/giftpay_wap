...
<head>
    ...
    <link type="text/css" href="css/getCardsuccess.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="js/getCardsuccess.js"></script>
...
<div class="zoomer">
    <div class="content">
        <div class="top">恭喜您！提现成功！</div>
        <div class="call">亲爱的会员盆友：</div>
        <div class="tip">您已成功将您的<span class="totleMoney"></span>元加油红包提现至您的油卡中，快去圈存使用吧！</div>
        <div class="chedaying">车答应</div>
        <div class="pic"><img src="img/erweima.png"width="180"height="178" alt=""/></div>
        <div class="tips">tips：什么是圈存？提现的金额信息已存入您的油卡账户，但还没存入您的IC卡里，请携带你的IC卡到加油站的圈存机上存入一下。</div>
...
<div class="fooot" style="width: 100%;height: 104px;background: rgba(27, 36, 34, 0.89);position: fixed;bottom: 0px;">
    ...
    <div class="pic" style="width: 74px;height: 74px;border-radius: 18px;overflow: hidden;position: absolute;right: -187px;top: 14px;border: 1px solid #fff;">
