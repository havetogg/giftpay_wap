...
<head>
    ...
    <link type="text/css" href="css/oilSold.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="js/oilSold.js"></script>
...
<div class="zoomer">
    ...
    <div class="content" style="min-height: 1140px ;background: #3fc0e7">
    <div class="oilSold" style="min-height: 1140px"><img src="img/20151030.jpg"  height="960" alt=""/></div>
    </div>
</div>
