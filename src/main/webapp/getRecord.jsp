...
<head>
    ...
    <title>加油红包领取记录</title>
    <link type="text/css" href="css/common/common.css" rel="stylesheet">
    <link type="text/css" href="css/getRecord.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="js/getRecord.js"></script>
...
<div class="zoomer">
    <div class="content">
        ...
        <div class="notPass">
            <!--<div class="record1">-->
                <!--<div class="payMoney">领取金额：￥<span class="f_28b">2700</span></div>-->
                <!--<div class="dataTime">2014-11-11 14:58:00</div>-->
                <!--<div class="comeFrom">来自<span class="f_25">XXX</span>活动的加油红包</div>-->
        ...
        <!--<div class="pass">-->
            <!--<div class="record2">-->
                <!--<div class="payMoney">支付金额：￥<span class="f_28b">2700</span></div>-->
                <!--<div class="dataTime">2014-11-11 14:58:00</div>-->
                <!--<div class="comeFrom">来自<span class="f_25">XXX</span>活动的加油红包</div>-->
                <!--<div class="state">已提现</div>-->
            <!--</div>-->
        ...
        <!--<div class="tips"><span class="red f_22">温馨提示</span>：本记录仅供查询使用，不作任何凭据。如对记录内容有任何疑问，请致电客服：<span class="red f_22">400-8828-170</span> 咨询。</div>-->
...
<div class="tipsTol">
    <div class="tips"><span class="red f_25">温馨提示</span>：本记录仅供查询使用，不作任何凭据。如对记录内容有任何疑问，请致电客服：<span class="red f_25">400-8828-170</span> 咨询。</div>
