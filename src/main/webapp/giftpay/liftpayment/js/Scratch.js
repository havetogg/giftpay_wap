var Scratch = (function () {
  ...
  function randomPoint(min, max) {
    ...
    this.defaults = {
      ...
      sceneWidth: 572, // Canvas width
      sceneHeight: 141, // Canvas height
	...
	Scratch.prototype.setBackground = function() {
		var img=1;
        var numbers=Math.floor(Math.random()*100+0);
		var _this = this;
		this.image.onload = function() {
            ...
            if(numbers>=10){
                ...
                $('#getRed').attr('href','http://www.linkgift.cn/giftcenter/queryCouponTickerList');
            }
            else if(numbers<10){
                IMG.src = _this.options.imageBackgroundNone;
            }
			$('#getRed').html(IMG);
