...
<style>
    *{
    ...
    .index_bg{
        background: url(img/red_bg123.png);
        height: 960px;
        width: 620px;
...
<script>
    ...
    $(function(){
    	...
    	if(thirdName=='pingan'){
    		$(".redNew_bg").css("background","url(img/redNew2.png)");
    		...
    		$(".redNew_bg").css("background","url(img/redNew.png)");
    ...
    function comitInfo(tel,code){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                loading("stop");
                TipShow(JSON.stringify(res),1000);
            }
        });
    }
            ...
            <div class="index_contentText" style="">
                <div>
                    ...
                    <div style="width: 90%;margin: 15px auto;">
                        <input id="code" style="width: 60%;" type="tel" placeholder="请输入您收到的短信验证码" maxlength="11" oninput="OnInput1 (event)" onpropertychange="OnPropChanged (event)">
