...
<head>
    ...
    <script>
     ...
     function sendCode(self) {
         ...
         if(countdown==60){
             $.ajax({
                 url:getRootPath()+"/wechat/carValuation/sendPhoneMsg.htm",
                 type:"post",
                 data:{"tel":phone},
                 dataType:"json",
        ...
        <div class="carValuation_content">
            <ul>
                ...
                <li>
                    ...
                    <label class="val_tel">
                        <input id="tel" type="tel" placeholder="请输入手机号 " class="input1" maxlength="11" style="padding-right: 40px;" onblur="this.style.textAlign='right'" onfocus="this.style.textAlign='center'">
                    </label>
                </li>
                <li>
                 <label class="icons">
            ...
            <span class="sellCar_bottom_text">通过有礼付一键卖车渠道成功卖车，即奖 <a>100</a>元无门槛加油红包。</span>
            </div>
        </div>
     ...
     /*    $.each(cityObj.city_list,function(index,item){
        ...
        if (!car) {
            ...
            $.ajax({
                ...
                data: {"modelId": modelId, "regDate": date, "mile": miles, "city": city,"status":"1","tel":tel,"msgCode":code},
                dataType: "json",
                type: "post",
                success: function (data) {
                	 loading("stop");
...
<script src="https://s13.cnzz.com/z_stat.php?id=1261960425&web_id=1261960425
