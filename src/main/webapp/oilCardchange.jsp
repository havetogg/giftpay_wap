...
<head>
    ...
    <link type="text/css" href="css/oilCardchange.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="js/oilCardchange.js"></script>
    ...
    <div class="content">
        ...
        <div class="form">
            <div class="information1">
                <!--<p ><span class="red f_28">*</span>旧加油卡号</p>-->
                <!--<p class="oldCard"></p>-->
                <p ><span class="red f_28">*</span>旧加油卡号</p>
                <input type="text" id="oldCard" maxlength="19" readonly="readonly" />
            ...
            <div class="protocol">
                ...
                <label for="checkBox" style="color: #666666;" class="checkBox">同意《车答应易加油服务条款》</label><br>
