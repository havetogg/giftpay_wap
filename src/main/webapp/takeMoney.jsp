...
<head>
    ...
    <title>加油红包提现记录</title>
    <link type="text/css" href="css/common/common.css" rel="stylesheet">
    <link type="text/css" href="css/takeMoney.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="js/takeMoney.js"></script>
...
<div class="zoomer">
    <div class="content">
        ...
        <div class="pass">
            <!--<div class="record2">-->
                <!--<div class="payMoney">提现金额：￥<span class="f_28b">2700</span></div>-->
                <!--<div class="dataTime">2014-11-11 14:58:00</div>-->
                <!--<div class="edu">使用红包数量：<span class="f_25">3</span></div>-->
